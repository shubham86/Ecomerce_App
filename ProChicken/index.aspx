<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="ProChicken.index" %>
...
<head>
    ...
    <meta id="head_twtTitle" property="og:title" content="Pro Chicken" />
    <meta id="head_twtDesc" property="og:description" content="Company Has Started Its Business In Pune (Maharashtra)In 2006 . All Production Parameters Are For Export Quality Only , Growing Of Broiler Birds Under Standard Feeding , Good Management &Healthy Environment We Have Our Own Production Farms For Broiler ( Chicken ) And Layers ( Eggs ) Which Is Monitored Under Technical Staff & It Is Leading By Experienced Veterinary Doctors Having 20 To 25 Years Experience In India As Well As International Market." />
    <meta id="head_twtImg" property="twitter:image" content="https://profeednpremix.com/assets/images/logo.png" />
    <meta id="head_twtURL" property="og:url" content="https://profeednpremix.com" />

    <meta id="head_ogTitle" property="og:title" content="Pro Chicken" />
    <meta id="head_ogDesc" property="og:description" content="Company Has Started Its Business In Pune (Maharashtra)In 2006 . All Production Parameters Are For Export Quality Only , Growing Of Broiler Birds Under Standard Feeding , Good Management &Healthy Environment We Have Our Own Production Farms For Broiler ( Chicken ) And Layers ( Eggs ) Which Is Monitored Under Technical Staff & It Is Leading By Experienced Veterinary Doctors Having 20 To 25 Years Experience In India As Well As International Market." />
    <meta id="head_ogImg" property="og:image" content="https://profeednpremix.com/assets/images/logo.png" />
    <meta id="head_ogURL" property="og:url" content="https://profeednpremix.com" />
    ...
    <style>
        ...
        .selected-paymode {
            ...
            font-size:20px;
                ...
                .selected-paymode input::selection {
                    background-color:transparent;;
                    color:#401212;
                }
                .selected-paymode input:focus{
    ...
    <script>
        ...
        function validation() {
            ...
            else if (document.getElementById('<%=txtFlat.ClientID%>').value == "") {
                document.getElementById("lblFlat").style.display = "block";
                document.getElementById('<%=txtFlat.ClientID%>').focus();
                return false;
            }
            else if (document.getElementById('<%=ddlBuilding.ClientID%>').value == "0") {
            ...
            else if (document.getElementById('<%=ddlPayMode.ClientID%>').value == "0") {
            ...
            <%--if (document.getElementById('<%=ddlPayMode.ClientID%>').value == "1" && document.getElementById('<%=txtTransactionID.ClientID%>').value == "") {
                ...
                var count = $(".product-name").length;
                var i;
                var table = document.getElementById("chkout-tbl");
                var sumQty = 0;
                table.innerHTML = "";
                for (i = 0; i < count; i++) {
                    if (document.getElementById("rptProducts_txtQuantity_" + i).value > 0) {
                        var row = table.insertRow(0);
                        var cell1 = row.insertCell(0);
                        var cell2 = row.insertCell(1);
                        var cell3 = row.insertCell(2);
                        cell1.innerHTML = document.getElementById("rptProducts_lblNAme_" + i).innerHTML + " " + document.getElementById("rptProducts_lblQty_" + i).innerHTML;
                        cell2.innerHTML = document.getElementById("rptProducts_txtQuantity_" + i).value;
                        cell3.innerHTML = document.getElementById("rptProducts_lblProductPrice_" + i).innerHTML;
                        cell1.width = "65%";
                        cell2.width = "10%";
                        cell3.width = "25%";
                        cell1.align = "left";
                ...
                $('.qty-input').each(function () {
                    sumQty = sumQty + parseInt(this.value);
                });

                document.getElementById('<%=lblProductCount.ClientID%>').innerHTML = sumQty;
        ...
        function paymodeChange() {
            ...
            if (document.getElementById('<%=ddlPayMode.ClientID%>').value == "1") {
                document.getElementById("GpayNo").style.display = "block";
                document.getElementById("PaytmNo").style.display = "none";
                document.getElementById("UpiID").style.display = "none";
                document.getElementById("note").style.display = "block";
            }
            else if (document.getElementById('<%=ddlPayMode.ClientID%>').value == "2") {
                document.getElementById("PaytmNo").style.display = "block";
                document.getElementById("GpayNo").style.display = "none";
                document.getElementById("UpiID").style.display = "none";
                document.getElementById("note").style.display = "block";
            }
            else if (document.getElementById('<%=ddlPayMode.ClientID%>').value == "3") {
        ...
        function copyText(id) {
          ...
          var elem = document.getElementById("lblcopied");
          var date = new Date();

            if (document.getElementById('<%=ddlPayMode.ClientID%>').value == "3") {
                elem.innerHTML = "UPI Copied...";
            }
            else {
                elem.innerHTML = "Number Copied...";
            }
        ...
        function copyText1(id) {
          ...
          var elem = document.getElementById("lblcopied1");
          var date = new Date();
        ...
        function getDetails() {
            if (document.getElementById('<%=txtMobile.ClientID%>').value.length == 10) {
                ...
                document.getElementById("select2-ddlBuilding-container").title = "--- Select Building ---";
                document.getElementById("select2-ddlBuilding-container").textContent = "--- Select Building ---";
        ...
        function onSetailSuccess(response) {
            if (response != "") {
                var arry = new Array();
                arry = response.split("$");
                document.getElementById('<%=lblCustomerID.ClientID%>').value = arry[0];
        ...
        function addQty(btnID) {
            var array = btnID.split("_");
            var qty = document.getElementById("rptProducts_txtQuantity_" + array[2]).value;
            var amt = document.getElementById("rptProducts_lblPrice_" + array[2]).innerHTML;
            qty++;
            document.getElementById("rptProducts_lblProductPrice_" + array[2]).innerHTML = (qty * amt).toFixed(2);
            document.getElementById("rptProducts_hfProductPrice_" + array[2]).value = document.getElementById("rptProducts_lblProductPrice_" + array[2]).innerHTML;

            var sumAmt = 0;
            $('.product-price').each(function () {
                sumAmt = sumAmt + parseFloat(this.innerHTML);
            });

            document.getElementById('<%=hfBillTotlal.ClientID%>').value = sumAmt.toFixed(2);
            document.getElementById('<%=lblBillTotal.ClientID%>').innerHTML = sumAmt.toFixed(2);
            document.getElementById('<%=lblBillTotal1.ClientID%>').innerHTML = sumAmt.toFixed(2);
            document.getElementById('<%=lblBillTotal2.ClientID%>').innerHTML = sumAmt.toFixed(2);
            document.getElementById('<%=lblBillTotal3.ClientID%>').innerHTML = sumAmt.toFixed(2);
            document.getElementById("lblEmptyCart").style.display = "none";
        }

        function subQty(btnID) {
            var array = btnID.split("_");
            var qty = document.getElementById("rptProducts_txtQuantity_" + array[2]).value;
            var amt = document.getElementById("rptProducts_lblPrice_" + array[2]).innerHTML;

            if (qty > 0) {
                document.getElementById("rptProducts_txtQuantity_" + array[2]).value = parseInt(document.getElementById("rptProducts_txtQuantity_" + array[2]).value) - 1;
                document.getElementById("rptProducts_lblProductPrice_" + array[2]).innerHTML = (document.getElementById("rptProducts_txtQuantity_" + array[2]).value * amt).toFixed(2);
                document.getElementById("rptProducts_hfProductPrice_" + array[2]).value = document.getElementById("rptProducts_lblProductPrice_" + array[2]).innerHTML;
        ...
        function typeQty(btnID, e) {
            ...
            if (document.getElementById("rptProducts_txtQuantity_" + array[2]).value == "") {
                document.getElementById("rptProducts_txtQuantity_" + array[2]).value = 0;
            }

            if (document.getElementById("rptProducts_txtQuantity_" + array[2]).value >= 0) {
                document.getElementById("rptProducts_lblProductPrice_" + array[2]).innerHTML = (document.getElementById("rptProducts_txtQuantity_" + array[2]).value * amt).toFixed(2);
                document.getElementById("rptProducts_hfProductPrice_" + array[2]).value = document.getElementById("rptProducts_lblProductPrice_" + array[2]).innerHTML;
                ...
                document.getElementById('hfBillTotlal').value = sumAmt.toFixed(2);
                document.getElementById('lblBillTotal').innerHTML = sumAmt.toFixed(2);
                document.getElementById('lblBillTotal1').innerHTML = sumAmt.toFixed(2);
                document.getElementById('lblBillTotal2').innerHTML = sumAmt.toFixed(2);
                document.getElementById('lblBillTotal3').innerHTML = sumAmt.toFixed(2);
            }
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="text-align: center">
                        ...
                        <div>
                            <div class="selected-paymode">
                                <img src="assets/images/gpay.png" width="40" />
                                <input id="lblGpayNo1" value="9881128367" readonly="true" /><i onclick="copyText1('lblGpayNo1')" class="fa fa-copy pl-3"></i>
                                <br />
                                <img src="assets/images/paytm.png" width="40" />
                                <input id="lblPaytmNo1" value="9881128367" readonly="true" /><i onclick="copyText1('lblPaytmNo1')" class="fa fa-copy pl-3"></i>
                                <br />
                                <img src="assets/images/UPI.jpg" width="40" />
                                <input id="lblUpiID1" value="shricorporate@dbs" readonly="true" /><i onclick="copyText1('lblUpiID1')" class="fa fa-copy pl-3"></i>

                                <label id="lblcopied1" class="lblcopied"></label>
                                <label class="note">Do payment befor or after order completion.</label>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-8 col-md-12 col-sm-12">
                        <asp:Repeater ID="rptProducts" runat="server">
                            <ItemTemplate>
                                <div class="row catlog product-catlog">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-12 p-0 catlog-details-box">
                                        <div class="catlog-details">
                                            <h3>
                                                <asp:Label ID="lblNAme" runat="server" CssClass="product-name" Text='<%# Eval("productName").ToString()%>'></asp:Label>
                                            </h3>
                                            <h4 class="color-yellow">
                                                <asp:Label ID="lblQty" runat="server" Text='<%# Eval("packageQuantity") %>' CssClass="package-qty"></asp:Label>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-12 qty-btn-box">
                                        <div class="input-group w-75">
                                            <asp:Button ID="btnMin" runat="server" CssClass="btn btn-qty" Text="-" OnClientClick="subQty(this.id);return false;" />                                            
                                            <asp:TextBox ID="txtQuantity" TextMode="Phone" runat="server" class="form-control input-number qty-input" Text="0" MaxLength="3" onkeyup="typeQty(this.id,event)" onkeydown="typeQty(this.id,event)" onfocus="this.select();"  onkeypress='javascript:return isNumberKey(event,this.id);'></asp:TextBox>
                                            <asp:Button ID="btnMax" runat="server" CssClass="btn quantity-right-plus btn-qty" Text="+" OnClientClick="addQty(this.id);return false;" />

                                        </div>
                                    </div>
                                    <div class="col-lg-2 col-md-2 col-sm-12 product-total-price">
                                        <h2><span class="rupee">₹</span>
                                            <asp:Label ID="lblProductPrice" runat="server" CssClass="product-price" Text="0.00"></asp:Label>
                                            <asp:HiddenField ID="hfProductPrice" runat="server" value="0.00"/>
                                        </h2>
                                    </div>
                                </div>
                            </ItemTemplate>
                        ...
                        <div class="row catlog contact">
                            <div id="loader1" class="loader">
                                <img class="loader-image" src="assets/images/small_loader.gif" width="60" />
                            </div>
                            <div class="check-out">
                                <h3>Total Bill Amount : <span class="color-orange">&nbsp;<span class="rupee"> ₹ </span>
                                    <asp:Label ID="lblBillTotal1" runat="server" Text="0.00"></asp:Label></span>
                                    <input id="hfBillTotlal" runat="server" type="hidden" value="0.00"/>
                                </h3>
                            </div>
                            <div class="col-lg-12 heading mt-3">
                                <h3>Customer Details
                                    <input id="lblCustomerID" runat="server" type="hidden" value="0"/>
                                    <%--<asp:TextBox ID="lblCustomerID" runat="server" Text="0" Font-Size="15px" ForeColor="black"></asp:TextBox>--%>
                            ...
                            <div class="col-lg-12 col-sm-12 field">
                                <asp:TextBox ID="txtMobile" TextMode="Phone" runat="server" CssClass="form-control" placeholder="&#xf10b; Mobile Number" MaxLength="10" onkeypress='javascript:return isNumberKey(event,this.id);' onfocusout="getDetails()"></asp:TextBox>
                            ...
                            <div class="col-lg-6 col-sm-12 field">
                                <asp:DropDownList ID="ddlPayMode" runat="server" CssClass="form-control" ForeColor="Gray" onchange="paymodeChange()" onclick="hidePayModelbl()">
                                    ...
                                    <asp:ListItem Text="Google Pay" Value="1"></asp:ListItem>
                                    <asp:ListItem Text="Paytm" Value="2"></asp:ListItem>
                                    <asp:ListItem Text="UPI" Value="3"></asp:ListItem>
                                    <asp:ListItem Text="COD" Value="4"></asp:ListItem>
                                ...
                                <div id ="GpayNo" class="selected-paymode">       
                                   <img src="assets/images/gpay.png" width="40"/> <input id="lblGpayNo" value="9881128367" readonly="true"/><i onclick="copyText('lblGpayNo')" class="fa fa-copy pl-3"></i>
                                </div>
                                <div id ="PaytmNo" class="selected-paymode">       
                                   <img src="assets/images/paytm.png" width="40"/> <input id="lblPaytmNo" value="9881128367"  readonly="true"/><i onclick="copyText('lblPaytmNo')" class="fa fa-copy pl-3"></i>
                                </div>
                                <div id ="UpiID" class="selected-paymode">       
                                    <img src="assets/images/UPI.jpg" width="40"/><input id="lblUpiID" value="shricorporate@dbs"  readonly="true"/><i onclick="copyText('lblUpiID')" class="fa fa-copy pl-3"></i>
                                </div>
                                <label id="lblcopied" class="lblcopied"></label>
                                <label id="note" class="note">Do payment befor or after order completion.</label>
                            </div>
                            ...
                            <div class="col-lg-12 col-sm-12 field mt-3" style="text-align: center">
                                ...
                                <a href="javascript:void(0)" id="btnCheckOut" class="btn btn-rounded" onclick="return validation()">Check Out</a>

                                <!-- Modal Popup -->
                                <div id="CheckoutPopup" class="modal fade" role="dialog">
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <table id="chkout-tbl" class="chkout-tbl" align="center"></table>
                                                <table class="chkout-tbl" align="center" style="border-top: 1px dashed #ccc; margin-top: 5px">
                                                    <tr>
                                                        <td colspan="3"></td>
                                                    </tr>
                                                    <tr>
                                                        <td width="65%" align="left"><b>Total</b></td>
                                ...
                                <div class="col-lg-6 col-md-12 ">
                                    <div class="footer-left">
                                        ...
                                        <div class="footer-detail">
                                            ...
                                            <div class="row about-payment">
                                                <div class="col-lg-4 col-sm-12 col-md-12">
                                                    <img src="assets/images/gpay.png" width="70"/> <label>9881128367</label>
                                                </div>
                                                <div class="col-lg-4 col-sm-12 col-md-12">
                                                    <img src="assets/images/paytm.png" width="70"/> <label>9881128367</label>
                                                </div>
                                                <div class="col-lg-4 col-sm-12 col-md-12">
                                                    <img src="assets/images/UPI.jpg" width="70"/> <label>shricorporate@dbs</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
