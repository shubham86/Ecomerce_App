    ...
    s === p && (s = -1 === v.serializeToString(i.parseXML(z["xl/worksheets/sheet1.xml"])).indexOf("xmlns:r"));
        ...
        { match: /^\-?[\d,]+\.\d{2}$/, style: 64 }]; l.ext.buttons.copyHtml5 = {
            className: "buttons-copy buttons-html5", text: function (a) { return a.i18n("buttons.copy", "Copy") }, action: function (a, c, d, b) {
                ...
                } f = i("<span>" + c.i18n("buttons.copyKeys", "Press <i>ctrl</i> or <i>⌘</i> + <i>C</i> to copy the table data<br>to your system clipboard.<br><br>To cancel, click this message or press escape.") + "</span>").append(d); c.buttons.info(c.i18n("buttons.copyTitle", "Copy to clipboard"), f, 0); b[0].focus(); b[0].select();
            ...
            bom: !1, className: "buttons-csv buttons-html5", available: function () { return g.FileReader !== p && g.Blob }, text: function (a) {
                return a.i18n("buttons.csv",
                    "CSV")
            }, action: function (a, c, d, b) { a = F(c, b).str; c = b.charset; b.customize && (a = b.customize(a, b)); !1 !== c ? (c || (c = k.characterSet || k.charset), c && (c = ";charset=" + c)) : c = ""; b.bom && (a = "﻿" + a); o(new Blob([a], { type: "text/csv" + c }), u(b), !0) }, filename: "*", extension: ".csv", exportOptions: {}, fieldSeparator: ",", fieldBoundary: '"', escapeChar: '"', charset: null, header: !0, footer: !1
